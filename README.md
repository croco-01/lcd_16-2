Here is your updated README. The table is now rewritten to show how to use your breadboard’s Positive (+) and Negative (-) power rails, making the physical setup much easier to follow.
